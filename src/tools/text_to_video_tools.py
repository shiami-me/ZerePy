...
def export_slide_to_image(slide, output_path: str, size=(1280, 720)):
    """Convert a slide to an image using Pillow with simplified text rendering."""
    ...
    if slide.shapes.title:
        ...
        _, height = get_text_dimensions(wrapped_title, title_font)
        draw.text((margin, y_position), wrapped_title, 
        ...
        if hasattr(shape, "has_text_frame") and shape.has_text_frame:
            for paragraph in shape.text_frame.paragraphs:
                ...
                if text.strip():
                    ...
                    _, height = get_text_dimensions(wrapped_text, body_font)
                    
                    draw.text((margin, y_position), wrapped_text, 
...
def convert_to_images(ppt_path: str, temp_dir: str) -> str:
    ...
    try:
        ...
        for slide_index, slide in enumerate(presentation.slides,1):
            ...
            export_slide_to_image(slide, static_image_path)
            ...
            for frame in range(10):
                ...
                static_image.save(transition_path, 'JPEG', quality = 95)
